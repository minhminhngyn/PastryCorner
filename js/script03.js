...
// Sự kiện kích hoạt khi click thêm vào giỏ hàng
...
function addtocart(productname, productprice, productimage) {
    ...
    var trcontent = '<tr><td><img src="' + productimage + '" alt="' + productname + '" class="product-img" style="display: none"><span class="tl">' + productname + '</span></td>' +
...
function addpromotion(total, discount_apply) {
    return total * (1 - discount_apply / 100);
}
